...
class Bot(commands.Bot):
    def __init__(self, client_id, oauth_token, category_name):
        ...
        super().__init__(token=oauth_token, client_id=client_id, prefix='!', initial_channels=self.channels)
    ...
    async def update_channels(self) -> None:
        while True:
            new_channels = get_live_channels(self.category_id, self.client_id, self.oauth_token)
